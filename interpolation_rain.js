  ...
  d3.json("twCounty2010.topo.json", function(countiestopo){
    ...
    return d3.json("stations.json", function(stations){
      ...
      colorOf = function(z){
        ...
        color = [d3.hsl(240, 1.0, 1.0), d3.hsl(240, 0.4, 0.7), d3.hsl(190, 0.4, 0.6), d3.hsl(130, 0.4, 0.6), d3.hsl(60, 0.4, 0.6), d3.hsl(30, 0.4, 0.6), d3.hsl(0, 0.4, 0.6), d3.hsl(-80, 0.4, 0.6), d3.hsl(-80, 1.0, 0.5), d3.hsl(-80, 1.0, 0.0)];
      ...
      return current.on('value', function(it){
        var res$, i$, ref$, len$, st, rainyjs;
        rainData = it.val();
        d3.select('#rainfall-timestamp').text("DATE: 2013-09-01 23:50:00");
