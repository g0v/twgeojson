...
(function(){
  var windowWidth, width, marginTop, height, canvas, svg, minLatitude, maxLatitude, minLongitude, maxLongitude, dy, dx, proj, drawTaiwan, ConvertDMSToDD, drawStations, drawSegment, addList, rainData, samples, distanceSquare, idwInterpolate, colorOf, yPixel, plotInterpolatedData, updateSevenSegment, drawHeatmap, drawAll;
